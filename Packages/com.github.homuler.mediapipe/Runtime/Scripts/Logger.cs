...
namespace Mediapipe
{
    ...
    {
        void Log(Logger.LogLevel logLevel, string tag, object message, Object context);
        void Log(Logger.LogLevel logLevel, string tag, object message);
        void Log(Logger.LogLevel logLevel, object message, Object context);
    ...
    public static class Logger
    {
        ...
        public static IExtendedLogger InternalLogger
        {
            get
            {
                if (_InternalLogger == null) _InternalLogger = new LoggerWrapper(Debug.unityLogger);
        ...
        {
            if (MinLogLevel >= LogLevel.Error) InternalLogger.LogException(exception, context);
        }
        ...
        {
            if (MinLogLevel >= LogLevel.Error) InternalLogger.LogException(exception);
        }
        ...
        {
            if (MinLogLevel >= LogLevel.Error) InternalLogger.LogError(tag, message, context);
        }
        ...
        {
            if (MinLogLevel >= LogLevel.Error) InternalLogger.LogError(tag, message);
        }
        ...
        {
            if (MinLogLevel >= LogLevel.Info) InternalLogger.LogWarning(tag, message, context);
        }
        ...
        {
            if (MinLogLevel >= LogLevel.Info) InternalLogger.LogWarning(tag, message);
        }
        ...
        [Conditional("DEBUG")]
        [Conditional("DEVELOPMENT_BUILD")]
        public static void Log(LogLevel logLevel, string tag, object message, Object context)
        {
            if (MinLogLevel >= logLevel) InternalLogger.Log(logLevel, tag, message, context);
        }
        ...
        {
            if (MinLogLevel >= logLevel) InternalLogger.Log(logLevel, tag, message);
        }
        ...
        {
            if (MinLogLevel >= logLevel) InternalLogger.Log(logLevel, message, context);
        }
        ...
        {
            if (MinLogLevel >= logLevel) InternalLogger.Log(logLevel, message);
        }
        ...
        [Conditional("DEBUG")]
        [Conditional("DEVELOPMENT_BUILD")]
        public static void LogInfo(string tag, object message, Object context)
        {
        ...
        [Conditional("DEBUG")]
        [Conditional("DEVELOPMENT_BUILD")]
        public static void LogVerbose(string tag, object message, Object context)
        {
        ...
        [Conditional("DEBUG")]
        [Conditional("DEVELOPMENT_BUILD")]
        public static void LogDebug(string tag, object message, Object context)
        {
        ...
        private class LoggerWrapper : IExtendedLogger
        {
            ...
            public void Log(LogLevel logLevel, string tag, object message, Object context)
            {
            ...
            public void Log(LogLevel logLevel, object message, Object context)
            {
