...
namespace Mediapipe
{
    internal static partial class UnsafeNativeMethods
    {
        ...
        [DllImport(MediaPipeLibrary, ExactSpelling = true)]
        public static extern MpReturnCode mp_Packet__GetNormalizedLandmarks(IntPtr packet,
            out NativeNormalizedLandmarks value);

        [DllImport(MediaPipeLibrary, ExactSpelling = true)]
        public static extern void mp_tasks_c_components_containers_CppCloseNormalizedLandmarks(
            NativeNormalizedLandmarks data);
