...
namespace Mediapipe
{
    internal static partial class UnsafeNativeMethods
    {
        ...
        [DllImport(MediaPipeLibrary, ExactSpelling = true)]
        public static extern MpReturnCode mp_ValidatedGraphConfig__Initialize__Rcgc(IntPtr config,
            byte[] serializedConfig, int size, out IntPtr status);
        ...
        [DllImport(MediaPipeLibrary, ExactSpelling = true)]
        public static extern MpReturnCode mp_ValidatedGraphConfig__RegisteredSidePacketTypeName(IntPtr config,
            string name,
