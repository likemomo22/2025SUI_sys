...
namespace Mediapipe
{
    ...
    public class ValidatedGraphConfig : MpResourceHandle
    {
        ...
        public void Initialize(CalculatorGraphConfig config)
        {
            ...
            UnsafeNativeMethods.mp_ValidatedGraphConfig__Initialize__Rcgc(mpPtr, bytes, bytes.Length, out var statusPtr)
                .Assert();
        ...
        {
            UnsafeNativeMethods
                .mp_ValidatedGraphConfig__ValidateRequiredSidePackets__Rsp(mpPtr, sidePacket.mpPtr, out var statusPtr)
                .Assert();
        ...
        {
            UnsafeNativeMethods
                .mp_ValidatedGraphConfig__RegisteredSidePacketTypeName(mpPtr, name, out var statusPtr, out var strPtr)
                .Assert();
        ...
        {
            UnsafeNativeMethods
                .mp_ValidatedGraphConfig__RegisteredStreamTypeName(mpPtr, name, out var statusPtr, out var strPtr)
                .Assert();
