...
namespace Mediapipe.Unity.Experimental
{
    public class TextureFramePool : IDisposable
    {
        ...
        /// </summary>
        private readonly ReaderWriterLockSlim _textureFramesLock = new();
        ...
        public TextureFramePool(int textureWidth, int textureHeight, TextureFormat textureFormat = TextureFormat.RGBA32,
            int poolSize = 10)
        {
        ...
        public void Dispose()
        {
            ...
            try
            {
                foreach (var textureFrame in _availableTextureFrames) textureFrame.Dispose();
                _availableTextureFrames.Clear();

                foreach (var textureFrame in _textureFramesInUse.Values) textureFrame.Dispose();
        ...
        public bool TryGetTextureFrame(out TextureFrame outFrame)
        {
            ...
            outFrame = nextFrame;
            if (result) nextFrame.WaitUntilReleased();
            return result;
        }
