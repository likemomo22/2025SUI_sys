...
namespace Mediapipe.Unity.CoordinateSystem
{
  ...
  ///     In real-world coordinate system, X axis is toward the right, Y axis is toward the bottom, and Z axis is toward the
  ///     back.
  /// </summary>
  public static class RealWorldCoordinate
    {
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3 RealWorldToLocalPoint(float x, float y, float z, float scaleX = 1, float scaleY = 1,
            float scaleZ = 1,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3 GetPoint(this UnityEngine.Rect _, Landmark landmark, Vector3 scale,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
