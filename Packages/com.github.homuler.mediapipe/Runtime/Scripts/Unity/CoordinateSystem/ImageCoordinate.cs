  ...
  public static class ImageCoordinate
    {
      ...
      public static Vector3 ImageToLocalPoint(int x, int y, int z, float xMin, float xMax, float yMin, float yMax,
            int imageWidth, int imageHeight, RotationAngle imageRotation = RotationAngle.Rotation0,
            bool isMirrored = false)
        {
            var isInverted = IsInverted(imageRotation);
            var (rectX, rectY) = isInverted ? (y, x) : (x, y);
            var (width, height) = (xMax - xMin, yMax - yMin);
            var localX = (IsXReversed(imageRotation, isMirrored) ? imageWidth - rectX : rectX) * width / imageWidth +
                         xMin;
            var localY = (IsYReversed(imageRotation, isMirrored) ? imageHeight - rectY : rectY) * height / imageHeight +
                         yMin;
      ...
      public static Vector3 ImageToPoint(UnityEngine.Rect rectangle, int x, int y, int z,
            ...
            bool isMirrored = false)
        {
            return ImageToLocalPoint(x, y, z, rectangle.xMin, rectangle.xMax, rectangle.yMin, rectangle.yMax,
                imageWidth, imageHeight, imageRotation, isMirrored);
        }
      ...
      public static Vector3 ImageToPoint(UnityEngine.Rect rectangle, Vector3Int position,
        ...
        {
            return ImageToPoint(rectangle, position.x, position.y, position.z, imageSize.x, imageSize.y, imageRotation,
                isMirrored);
        }
      ...
      public static Vector3 ImageToPoint(UnityEngine.Rect rectangle, int x, int y,
            ...
            bool isMirrored = false)
        {
            return ImageToLocalPoint(x, y, 0, rectangle.xMin, rectangle.xMax, rectangle.yMin, rectangle.yMax,
                imageWidth, imageHeight, imageRotation, isMirrored);
        }
      ...
      public static Vector3 ImageNormalizedToLocalPoint(float normalizedX, float normalizedY, float normalizedZ,
      ...
      public static Vector3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, float normalizedX, float normalizedY,
            ...
            float zScale, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageNormalizedToLocalPoint(normalizedX, normalizedY, normalizedZ, rectangle.xMin, rectangle.xMax,
                rectangle.yMin, rectangle.yMax, zScale, imageRotation, isMirrored);
        }
      ...
      public static Vector3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, Vector3 position,
            float zScale, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageNormalizedToPoint(rectangle, position.x, position.y, position.z, zScale, imageRotation,
                isMirrored);
        }
      ...
      public static Vector3 ImageNormalizedToLocalPoint(float normalizedX, float normalizedY, float normalizedZ,
            ...
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            ...
            return ImageNormalizedToLocalPoint(normalizedX, normalizedY, normalizedZ, xMin, xMax, yMin, yMax, zScale,
      ...
      public static Vector3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, float normalizedX, float normalizedY,
        ...
        {
            return ImageNormalizedToLocalPoint(normalizedX, normalizedY, normalizedZ, rectangle.xMin, rectangle.xMax,
                rectangle.yMin, rectangle.yMax, imageRotation, isMirrored);
        }
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3 ImageNormalizedToPoint(UnityEngine.Rect rectangle, Vector2 position,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3[] ImageToRectVertices(UnityEngine.Rect rectangle, int xMin, int yMin, int width,
            int height,
            int imageWidth, int imageHeight, RotationAngle imageRotation = RotationAngle.Rotation0,
            bool isMirrored = false)
        {
      ...
      public static Vector3[] ImageToRectVertices(UnityEngine.Rect rectangle, int xMin, int yMin, int width,
            ...
            Vector2Int imageSize, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageToRectVertices(rectangle, xMin, yMin, width, height, imageSize.x, imageSize.y, imageRotation,
                isMirrored);
        }
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3[] ImageNormalizedToRectVertices(UnityEngine.Rect rectangle, float normalizedXMin,
            float normalizedYMin, float normalizedWidth, float normalizedHeight,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            var p = ImageNormalizedToPoint(rectangle, normalizedXMin, normalizedYMin + normalizedHeight, imageRotation,
                isMirrored);
            var q = ImageNormalizedToPoint(rectangle, normalizedXMin + normalizedWidth, normalizedYMin, imageRotation,
                isMirrored);
            return GetRectVertices(p, q);
        }
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3[] ImageToRectVertices(UnityEngine.Rect rectangle, int xCenter, int yCenter, int width,
            ...
            bool isMirrored = false)
        {
            ...
            var isRotationReversed = isInverted ^ IsXReversed(imageRotation, isMirrored) ^
                                     IsYReversed(imageRotation, isMirrored);
      ...
      public static Vector3[] ImageToRectVertices(UnityEngine.Rect rectangle, int xCenter, int yCenter, int width,
            ...
            Vector2Int imageSize, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageToRectVertices(rectangle, xCenter, yCenter, width, height, rotation, imageSize.x, imageSize.y,
                imageRotation, isMirrored);
        }
      ...
      /// </param>
      /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
      public static Vector3[] ImageNormalizedToRectVertices(UnityEngine.Rect rectangle, float normalizedXCenter,
            ...
            float rotation, RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            ...
            var center = ImageNormalizedToPoint(rectangle, normalizedXCenter, normalizedYCenter, imageRotation,
                isMirrored);
            var isRotationReversed = isInverted ^ IsXReversed(imageRotation, isMirrored) ^
                                     IsYReversed(imageRotation, isMirrored);
            var quaternion = Quaternion.Euler(0, 0, (isRotationReversed ? -1 : 1) * Mathf.Rad2Deg * rotation);
        ...
        public static Vector2 GetPoint(this UnityEngine.Rect rectangle, mptcc.NormalizedKeypoint normalizedKeypoint,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageNormalizedToPoint(rectangle, normalizedKeypoint.x, normalizedKeypoint.y, imageRotation,
                isMirrored);
        }
        ...
        public static Vector3 GetPoint(this UnityEngine.Rect rectangle, NormalizedLandmark normalizedLandmark,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageNormalizedToPoint(rectangle, normalizedLandmark.X, normalizedLandmark.Y, normalizedLandmark.Z,
                imageRotation, isMirrored);
        }
        ...
        /// <summary>
        ///     Get a Vector3 array which represents <paramref name="boundingBox" />'s vertex coordinates in the local coordinate
        ///     system.
        ...
        /// </param>
        /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
        public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, mplt.BoundingBox boundingBox,
            int imageWidth, int imageHeight,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageToRectVertices(rectangle, boundingBox.Xmin, boundingBox.Ymin, boundingBox.Width,
                boundingBox.Height, imageWidth, imageHeight, imageRotation, isMirrored);
        }
        ...
        {
            return ImageToRectVertices(rectangle, boundingBox.Xmin, boundingBox.Ymin, boundingBox.Width,
                boundingBox.Height, imageSize, imageRotation, isMirrored);
        }
        ...
        public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, mplt.RelativeBoundingBox boundingBox,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageNormalizedToRectVertices(rectangle, boundingBox.Xmin, boundingBox.Ymin, boundingBox.Width,
                boundingBox.Height, imageRotation, isMirrored);
        }
        ...
        /// </param>
        /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
        public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, mptcc.Rect rect, int imageWidth,
            int imageHeight,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageToRectVertices(rectangle, rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top,
                imageWidth, imageHeight, imageRotation, isMirrored);
        }
        ...
        {
            return ImageToRectVertices(rectangle, rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top,
                imageSize, imageRotation, isMirrored);
        }
        ...
        /// </param>
        /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
        public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, Rect rect, int imageWidth,
            int imageHeight,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageToRectVertices(rectangle, rect.XCenter, rect.YCenter, rect.Width, rect.Height, rect.Rotation,
                imageWidth, imageHeight, imageRotation, isMirrored);
        }
        ...
        /// <summary>
        ///     Get a Vector3 array which represents <paramref name="normalizedRect" />'s vertex coordinates in the local
        ///     coordinate system.
        ///     They are ordered clockwise from bottom-left point.
        /// </summary>
        /// <param name="rectangle">Rectangle to get a point inside</param>
        ...
        public static Vector3[] GetRectVertices(this UnityEngine.Rect rectangle, NormalizedRect normalizedRect,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            return ImageNormalizedToRectVertices(rectangle, normalizedRect.XCenter, normalizedRect.YCenter,
                normalizedRect.Width, normalizedRect.Height, normalizedRect.Rotation, imageRotation, isMirrored);
        }
        ...
        /// </param>
        /// <param name="isMirrored">Set to true if the original coordinates is mirrored</param>
        public static Vector2 PointToImageNormalized(this UnityEngine.Rect rectangle, Vector2 localPosition,
            RotationAngle imageRotation = RotationAngle.Rotation0, bool isMirrored = false)
        {
            ...
            var normalizedY = IsYReversed(imageRotation, isMirrored)
                ...
                : Mathf.InverseLerp(-rectangle.height / 2, rectangle.height / 2, localPosition.y);
            return IsInverted(imageRotation)
                ? new Vector2(normalizedY, normalizedX)
                : new Vector2(normalizedX, normalizedY);
        }

        /// <summary>
        ///     When the image is rotated back, returns whether the axis parallel to the X axis of the Unity coordinates is
        ///     pointing in the same direction as the X axis of the Unity coordinates.
        ///     For example, if <paramref name="rotationAngle" /> is <see cref="RotationAngle.Rotation90" /> and
        ///     <paramRef name="isMirrored" /> is <c>false</c>, this returns <c>true</c>
        ...
        /// <summary>
        ///     Returns <c>true</c> if <paramref name="rotationAngle" /> is <see cref="RotationAngle.Rotation90" /> or
        ///     <see cref="RotationAngle.Rotation270" />.
        /// </summary>
