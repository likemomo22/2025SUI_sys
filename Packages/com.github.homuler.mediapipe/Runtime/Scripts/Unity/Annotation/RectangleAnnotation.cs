...
#pragma warning restore IDE0065
    ...
    {
        private static readonly Vector3[] _EmptyPositions = { Vector3.zero, Vector3.zero, Vector3.zero, Vector3.zero };
        ...
        {
            if (ActivateFor(target)) Draw(GetScreenRect().GetRectVertices(target, rotationAngle, isMirrored));
        }
