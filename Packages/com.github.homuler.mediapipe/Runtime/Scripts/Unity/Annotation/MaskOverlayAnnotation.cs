...
#pragma warning restore IDE0065
    ...
    public class MaskOverlayAnnotation : HierarchicalAnnotation
    {
        ...
        private void OnEnable()
        {
            ...
            if (_screenObject != null) _screenObject.SetActive(true);
        }

        private void OnDisable()
        {
            if (_prevMaterial != null) ApplyMaterial(_prevMaterial);
            if (_screenObject != null) _screenObject.SetActive(false);
        }

        private void OnDestroy()
        {
            if (_maskBuffer != null) _maskBuffer.Release();
            _maskArray = null;
            _prevMaterial = null;
            _material = null;
        ...
        {
            if (_screenObject != null) Destroy(_screenObject);
        ...
        private Texture2D CreateMonoColorTexture(Color color)
        {
            ...
            var textureColor = new Color32((byte)(255 * color.r), (byte)(255 * color.g), (byte)(255 * color.b),
                (byte)(255 * color.a));
            texture.SetPixels32(new[] { textureColor });
            texture.Apply();
        ...
        private void ApplyMaterial(Material material)
        {
            ...
            if (_screen.material != material) _screen.material = material;
        }
