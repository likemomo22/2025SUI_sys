...
#pragma warning restore IDE0065
    ...
    public class PointListAnnotation : ListAnnotation<PointAnnotation>
    {
        ...
        private void Awake()
        {
            ...
            {
                targetMuscleCube = GameObject.Find("TargetMuscleCircleVer3");
                Debug.Log("GET");
            }

            if (subMuscleCube1 == null) subMuscleCube1 = GameObject.Find("SubMuscleCircle1Ver3");
            if (subMuscleCube2 == null) subMuscleCube2 = GameObject.Find("SubMuscleCircle2Ver3");
        }
