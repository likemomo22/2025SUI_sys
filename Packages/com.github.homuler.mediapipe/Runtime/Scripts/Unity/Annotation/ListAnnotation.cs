...
namespace Mediapipe.Unity
{
    public abstract class ListAnnotation<T> : HierarchicalAnnotation where T : HierarchicalAnnotation
    {
        ...
        public override bool isMirrored
        {
            set
            {
                foreach (var child in children) child.isMirrored = value;
        ...
        public override RotationAngle rotationAngle
        {
            set
            {
                foreach (var child in children) child.rotationAngle = value;
        ...
        {
            while (children.Count < count) children.Add(InstantiateChild(false));
        }
        ...
        /// <summary>
        ///     Zip <see cref="children" /> and <paramref name="argumentList" />, and call <paramref name="action" /> with each
        ///     pair.
        ///     If <paramref name="argumentList" /> has more elements than <see cref="children" />, <see cref="children" />
        ///     elements will be initialized with <see cref="InstantiateChild" />.
        /// </summary>
        /// <param name="action">
