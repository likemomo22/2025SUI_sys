...
namespace Mediapipe.Unity
{
    public class MultiHandLandmarkListAnnotationController : AnnotationController<MultiHandLandmarkListAnnotation>
    {
        ...
        public void DrawNow(IReadOnlyList<NormalizedLandmarkList> handLandmarkLists,
            IReadOnlyList<ClassificationList> handedness = null)
        {
        ...
        protected override void SyncNow()
        {
            ...
            if (_currentHandedness != null) annotation.SetHandedness(_currentHandedness);
