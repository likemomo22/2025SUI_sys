  ...
  public readonly struct Detection
    {
        ...
        public static void Copy(Mediapipe.Detection proto, ref Detection destination)
        {
            ...
            var boundingBox = proto.LocationData != null
                ? new Rect(
            ...
            var keypoints = destination.keypoints ??
...
#pragma warning restore IDE0004
        ...
        internal static void Copy(in NativeDetection source, ref Detection destination)
        {
            ...
            keypoints.Clear();
            foreach (var nativeKeypoint in source.keypoints) keypoints.Add(new NormalizedKeypoint(nativeKeypoint));
  ...
  public readonly struct DetectionResult
    {
      ...
      public readonly List<Detection> detections;
        ...
        {
            return new DetectionResult(new List<Detection>(capacity));
        }
