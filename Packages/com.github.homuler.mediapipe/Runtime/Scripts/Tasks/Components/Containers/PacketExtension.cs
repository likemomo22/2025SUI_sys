...
namespace Mediapipe.Tasks.Components.Containers
{
    public static class PacketExtension
    {
        ...
        {
            UnsafeNativeMethods.mp_Packet__GetClassificationsVector(packet.mpPtr, out var classificationResult)
                .Assert();
        ...
        public static void GetClassificationsVector(this Packet<List<Classifications>> packet,
            List<Classifications> outs)
        {
            Get(packet, outs);
        }
        ...
        {
            UnsafeNativeMethods.mp_Packet__GetClassificationResultVector(packet.mpPtr, out var classificationResults)
                .Assert();
