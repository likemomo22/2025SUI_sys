  ...
  public readonly struct Classifications
    {
      ...
      public readonly string headName;
        ...
        public static void Copy(Proto.Classifications source, ref Classifications destination)
        {
            ...
            destination =
                new Classifications(categories, source.HeadIndex, source.HasHeadName ? source.HeadName : null);
        }

        public static void Copy(ClassificationList source, int headIndex, string headName,
            ref Classifications destination)
        {
        ...
        internal static void Copy(NativeClassifications source, ref Classifications destination)
        {
            ...
            categories.Clear();
            foreach (var nativeCategory in source.categories) categories.Add(new Category(nativeCategory));
...
#pragma warning restore IDE0004 // for Unity 2020.3.x
        ...
        {
            var classificationsList = destination.classifications ??
                                      new List<Classifications>((int)source.classificationsCount);
            ...
            destination =
                new ClassificationResult(classificationsList, source.hasTimestampMs ? source.timestampMs : null);
        }
