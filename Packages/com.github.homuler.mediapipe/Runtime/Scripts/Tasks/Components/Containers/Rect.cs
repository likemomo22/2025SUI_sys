  ...
  public readonly struct Rect
    {
        ...
        internal Rect(NativeRect nativeRect) : this(nativeRect.left, nativeRect.top, nativeRect.right,
            nativeRect.bottom)
        {
        }
  ...
  public readonly struct RectF : IEquatable<RectF>
    {
        ...
        internal RectF(NativeRectF nativeRect) : this(nativeRect.left, nativeRect.top, nativeRect.right,
            nativeRect.bottom)
        {
        }
