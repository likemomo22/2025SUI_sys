...
using Mediapipe.Tasks.Vision.HolisticLandmarker.Proto;
...
namespace Mediapipe.Tasks.Vision.HolisticLandmarker
{
  ...
  /// </summary>
  public sealed class HolisticLandmarkerOptions : ITaskOptions
    {
      ...
      /// </param>
      public delegate void ResultCallback(in HolisticLandmarkerResult holisticLandmarkerResult, Image image,
        ...
        ///         <item>
        ///             <description>
        ///                 The live stream mode or detecting holistic landmarks on the live stream of input data, such as from
        ///                 camera.
        ...
        /// <summary>
        ///     Whether HolisticLandmarker outputs face blendshapes classification. Face blendshapes are used for rendering the 3D
        ///     face model.
        /// </summary>
        ...
        Any ITaskOptions.ToAnyOptions()
        {
            return Any.Pack(ToProto());
        }

        internal HolisticLandmarkerGraphOptions ToProto()
        {
