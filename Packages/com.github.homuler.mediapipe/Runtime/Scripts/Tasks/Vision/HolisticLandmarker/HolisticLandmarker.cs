...
{
    public sealed class HolisticLandmarker : BaseVisionTaskApi
    {
...
#pragma warning restore IDE0052
        ...
        /// <summary>
        ///     Creates an <see cref="HolisticLandmarker" /> object from a TensorFlow Lite model and the default
        ...
        /// </param>
        /// <returns>
        ///     <see cref="HolisticLandmarker" /> object that's created from the model and the default
        ///     <see cref="HolisticLandmarkerOptions" />.
        /// </returns>
        public static HolisticLandmarker CreateFromModelPath(string modelPath, GpuResources gpuResources = null)
        {
            ...
            var options = new HolisticLandmarkerOptions(baseOptions, RunningMode.IMAGE);
        ...
        /// </returns>
        public static HolisticLandmarker CreateFromOptions(HolisticLandmarkerOptions options,
            GpuResources gpuResources = null)
        {
            ...
            var taskInfo = new TaskInfo<HolisticLandmarkerOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
        ...
        private static TaskRunner.PacketsCallback BuildPacketsCallback(HolisticLandmarkerOptions options)
        {
        ...
        private static bool TryBuildHolisticLandmarkerResult(PacketMap outputPackets,
            ref HolisticLandmarkerResult result)
        {
            ...
            using var leftHandWorldLandmarksPacket =
                outputPackets.At<Landmarks>(_LEFT_HAND_WORLD_LANDMARKS_STREAM_NAME);
            ...
            using var rightHandLandmarksPacket =
                outputPackets.At<NormalizedLandmarks>(_RIGHT_HAND_LANDMARKS_STREAM_NAME);
            ...
            using var rightHandWorldLandmarksPacket =
                outputPackets.At<Landmarks>(_RIGHT_HAND_WORLD_LANDMARKS_STREAM_NAME);
