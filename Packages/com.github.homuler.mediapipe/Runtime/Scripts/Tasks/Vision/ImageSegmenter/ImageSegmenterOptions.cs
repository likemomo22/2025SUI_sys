...
namespace Mediapipe.Tasks.Vision.ImageSegmenter
{
  ...
  /// </summary>
  public sealed class ImageSegmenterOptions : ITaskOptions
    {
      /// <remarks>
      ...
      /// </param>
      public delegate void ResultCallback(ImageSegmenterResult segmentationResult, Image image,
        ...
        internal ImageSegmenterGraphOptions ToProto()
        {
            ...
            var options = new ImageSegmenterGraphOptions
            {
