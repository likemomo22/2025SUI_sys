...
#pragma warning restore IDE0052
        ...
        public static HandLandmarker CreateFromModelPath(string modelPath, GpuResources gpuResources = null)
        {
            ...
            var options = new HandLandmarkerOptions(baseOptions);
        ...
        {
            var taskInfo = new TaskInfo<HandLandmarkerOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
        ...
        public bool TryDetectForVideo(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions, ref HandLandmarkerResult result)
        {
            using var outputPackets = DetectForVideoInternal(image, timestampMillisec, imageProcessingOptions);
            return TryBuildHandLandmarkerResult(outputPackets, ref result);
        }
