...
namespace Mediapipe.Tasks.Vision.ObjectDetector
{
  ...
  /// </summary>
  public sealed class ObjectDetectorOptions : ITaskOptions
    {
      /// <remarks>
      ...
      /// </param>
      public delegate void ResultCallback(DetectionResult detectionResult, Image image, long timestampMillisec);
