...
#pragma warning restore IDE0052
        ...
        public static ObjectDetector CreateFromModelPath(string modelPath, GpuResources gpuResources = null)
        {
            ...
            var options = new ObjectDetectorOptions(baseOptions);
        ...
        {
            var taskInfo = new TaskInfo<ObjectDetectorOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
        ...
        public bool TryDetectForVideo(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions, ref ObjectDetectorResult result)
        {
            using var outputPackets = DetectForVideoInternal(image, timestampMillisec, imageProcessingOptions);
            return TryBuildObjectDetectorResult(outputPackets, ref result);
        }
