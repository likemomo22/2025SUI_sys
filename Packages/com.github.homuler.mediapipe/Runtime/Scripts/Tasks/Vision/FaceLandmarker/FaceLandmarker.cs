...
#pragma warning restore IDE0052
        ...
        public static FaceLandmarker CreateFromModelPath(string modelPath, GpuResources gpuResources = null)
        {
            ...
            var options = new FaceLandmarkerOptions(baseOptions);
        ...
        public static FaceLandmarker CreateFromOptions(FaceLandmarkerOptions options, GpuResources gpuResources = null)
        {
            ...
            var taskInfo = new TaskInfo<FaceLandmarkerOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
            ...
            var faceGeometriesForRead = options.outputFaceTransformationMatrixes
        ...
        /// </returns>
        public bool TryDetect(Image image, ImageProcessingOptions? imageProcessingOptions,
        ...
        public bool TryDetectForVideo(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions, ref FaceLandmarkerResult result)
        {
            using var outputPackets = DetectForVideoInternal(image, timestampMillisec, imageProcessingOptions);
            return TryBuildFaceLandmarkerResult(outputPackets, ref result);
        }
            ...
            List<FaceGeometry.Proto.FaceGeometry> faceGeometriesForRead)
        {
            ...
            var faceLandmarkerResult = FaceLandmarkerResult.Alloc(options.numFaces, options.outputFaceBlendshapes,
                options.outputFaceTransformationMatrixes);
        ...
        {
            foreach (var geometry in outs) geometry.Clear();
            ...
            ref FaceLandmarkerResult result)
        {
            ...
            using var faceTransformationMatrixesPacket =
