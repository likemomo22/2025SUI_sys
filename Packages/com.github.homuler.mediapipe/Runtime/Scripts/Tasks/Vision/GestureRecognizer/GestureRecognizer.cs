...
namespace Mediapipe.Tasks.Vision.GestureRecognizer
{
  ...
  /// </summary>
  public sealed class GestureRecognizer : BaseVisionTaskApi
    {
...
#pragma warning disable IDE0052 // Remove unread private members
      ...
      /// </remarks>
      private readonly TaskRunner.PacketsCallback _packetCallback;
#pragma warning restore IDE0052
        ...
        /// <summary>
        ///     Creates an <see cref="GestureRecognizer" /> object from a TensorFlow Lite model and the default
        ///     <see cref="GestureRecognizerOptions" />.
        ...
        ///     <returns>
        ///         <see cref="GestureRecognizer" /> object that's created from the model and the default
        ///         <see cref="GestureRecognizerOptions" />.
        ///     </returns>
        public static GestureRecognizer CreateFromModelPath(string modelPath, GpuResources gpuResources = null)
        {
            ...
            var options = new GestureRecognizerOptions(baseOptions);
        ...
        /// </returns>
        public static GestureRecognizer CreateFromOptions(GestureRecognizerOptions options,
            GpuResources gpuResources = null)
        {
            var taskInfo = new TaskInfo<GestureRecognizerOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
            ...
            return new GestureRecognizer(
                taskInfo.GenerateGraphConfig(options.runningMode == RunningMode.LIVE_STREAM),
                options.runningMode,
                gpuResources,
        ...
        public GestureRecognizerResult Recognize(Image image, ImageProcessingOptions? imageProcessingOptions = null)
        {
        ...
        /// </returns>
        public bool TryRecognize(Image image, ImageProcessingOptions? imageProcessingOptions,
            ref GestureRecognizerResult result)
        {
            using var outputPackets = RecognizeInternal(image, imageProcessingOptions);
            return TryBuildGestureRecognizerResult(outputPackets, ref result);
        }

        private PacketMap RecognizeInternal(Image image, ImageProcessingOptions? imageProcessingOptions)
        {
        ...
        /// <param name="imageProcessingOptions">Options for image processing.</param>
        /// <returns>The hand gesture recognition results.</returns>
        public GestureRecognizerResult RecognizeForVideo(Image image, long timestampMillisec,
        ...
        ///     <see langword="true" /> if some gestures are detected, <see langword="false" /> otherwise.
        /// </returns>
        public bool TryRecognizeForVideo(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions, ref GestureRecognizerResult result)
        {
            using var outputPackets = RecognizeForVideoInternal(image, timestampMillisec, imageProcessingOptions);
            return TryBuildGestureRecognizerResult(outputPackets, ref result);
        }

        private PacketMap RecognizeForVideoInternal(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions = null)
        {
            ConfigureNormalizedRect(_normalizedRect, imageProcessingOptions, image, false);
        ...
        /// </exception>
        public void RecognizeAsync(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions = null)
        {
            ConfigureNormalizedRect(_normalizedRect, imageProcessingOptions, image, false);
            var timestampMicrosec = timestampMillisec * _MICRO_SECONDS_PER_MILLISECOND;
        ...
        private static TaskRunner.PacketsCallback BuildPacketsCallback(GestureRecognizerOptions options)
        {
        ...
        private static bool TryBuildGestureRecognizerResult(PacketMap outputPackets, ref GestureRecognizerResult result)
        {
            ...
            if (gesturesPacket.IsEmpty()) return false;
