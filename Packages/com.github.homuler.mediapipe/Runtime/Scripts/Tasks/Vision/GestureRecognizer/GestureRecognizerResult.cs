...
{
  /// <summary>
  ///     The gesture recognition result from GestureRecognizer, where each vector element represents a single hand detected
  ///     in the image.
  /// </summary>
  public readonly struct GestureRecognizerResult
    {
      ...
      public readonly List<Landmarks> handWorldLandmarks;
        ...
        public void CloneTo(ref GestureRecognizerResult destination)
        {
            ...
            destination =
                new GestureRecognizerResult(dstGestures, dstHandedness, dstHandLandmarks, dstHandWorldLandmarks);
        }
