...
#pragma warning restore IDE0052
        ...
        public static FaceDetector CreateFromModelPath(string modelPath, GpuResources gpuResources = null)
        {
            ...
            var options = new FaceDetectorOptions(baseOptions);
        ...
        {
            var taskInfo = new TaskInfo<FaceDetectorOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
        ...
        public bool TryDetectForVideo(Image image, long timestampMillisec,
            ImageProcessingOptions? imageProcessingOptions, ref FaceDetectionResult result)
        {
            using var outputPackets = DetectForVideoInternal(image, timestampMillisec, imageProcessingOptions);
            return TryBuildFaceDetectorResult(outputPackets, ref result);
        }
