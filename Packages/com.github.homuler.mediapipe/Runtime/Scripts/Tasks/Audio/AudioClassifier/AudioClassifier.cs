...
#pragma warning restore IDE0052
        ...
        public static AudioClassifier CreateFromModelPath(string modelPath)
        {
            ...
            var options = new AudioClassifierOptions(baseOptions, RunningMode.AUDIO_CLIPS);
        ...
        {
            var taskInfo = new TaskInfo<AudioClassifierOptions>(
                _TASK_GRAPH_NAME,
                new List<string>
                {
        ...
        private static bool TryBuildAudioClassifierResultList(PacketMap outputPackets,
            List<AudioClassifierResult> result)
        {
            using var outPacket =
