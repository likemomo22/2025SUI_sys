...
namespace Mediapipe
{
    public class GlCalculatorHelper : MpResourceHandle
    {
        ...
        {
            UnsafeNativeMethods
                .mp_GlCalculatorHelper__CreateSourceTexture__Rif(mpPtr, imageFrame.mpPtr, out var texturePtr).Assert();
        ...
        {
            UnsafeNativeMethods
                .mp_GlCalculatorHelper__CreateSourceTexture__Rgb(mpPtr, gpuBuffer.mpPtr, out var texturePtr).Assert();
    ...
    public GlTexture CreateSourceTexture(GpuBuffer gpuBuffer, int plane) {
      ...
      return new GlTexture(texturePtr);
        ...
        {
            UnsafeNativeMethods
                .mp_GlCalculatorHelper__CreateDestinationTexture__Rgb(mpPtr, gpuBuffer.mpPtr, out var texturePtr)
                .Assert();
