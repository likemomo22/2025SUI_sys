...
namespace Mediapipe.Unity.CoordinateSystem.Tests
{
    public class ImageCoordinateTest
    {
        ...
        public void ImageToPoint_ShouldReturnLocalPoint_When_ImageSizeIsSameAsScreenSize(int width, int height, int x,
            int y, int z, RotationAngle imageRotation, bool isMirrored,
        ...
        public void ImageToPoint_ShouldReturnLocalPoint_When_ImageSizeIsNotSameAsScreenSize(int imageWidth,
        ...
        public void ImageToPoint_ShouldReturnLocalPoint_When_TheAnchorOfRectIsNotAtTheCenter(int width, int height,
            int x, int y, float xMin, float xMax, float yMin, float yMax,
        ...
        public void ImageNormalizedToPoint_ShouldReturnLocalPoint_When_TheAnchorOfRectIsAtTheCenter(int width,
        ...
        public void ImageNormalizedToPoint_ShouldReturnLocalPoint_When_TheAnchorOfRectIsNotAtTheCenter(
            float normalizedX, float normalizedY, float normalizedZ, float xMin, float xMax, float yMin, float yMax,
            RotationAngle imageRotation, bool isMirrored, float expectedX, float expectedY, float expectedZ)
        {
            var rect = BuildRect(xMin, xMax, yMin, yMax);
            var result = ImageCoordinate.ImageNormalizedToPoint(rect, normalizedX, normalizedY, normalizedZ,
        ...
        [TestCase(640, 480, 0, 0, -1, 100, RotationAngle.Rotation270, true, -100)]
        [TestCase(640, 480, 0, 0, -0.5f, 100, RotationAngle.Rotation270, true, -50)]
        public void ImageNormalizedToPoint_ShouldReturnLocalPoint_When_ZScaleIsSpecified(int width, int height,
