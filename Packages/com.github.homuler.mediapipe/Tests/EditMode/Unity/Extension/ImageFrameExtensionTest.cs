...
namespace Mediapipe.Unity.Tests
{
    ...
    {
        private ImageFrame BuildImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep,
            byte[] pixelData)
        {
        ...
        private byte[] FloatsToBytes(float[] array)
        {
            ...
            unsafe
            {
                fixed (float* pArray = array)
                {
                    ...
                    for (var i = 0; i < 4 * array.Length; i++) bytes[i] = *pByte++;
                }
            }
        ...
        public void TryReadChannelByte_ShouldReadTheSpecifiedChannelData_When_TheFormatIsSrgb()
        {
            ...
            {
                Assert.True(imageFrame.TryReadChannel(0, result));
                ...
                Assert.True(imageFrame.TryReadChannel(0, result, true));
                ...
                Assert.True(imageFrame.TryReadChannel(1, result));
                ...
                Assert.True(imageFrame.TryReadChannel(1, result, true));
                ...
                Assert.True(imageFrame.TryReadChannel(2, result));
                ...
                Assert.True(imageFrame.TryReadChannel(2, result, true));
        ...
        public void TryReadChannelByte_ShouldReadTheSpecifiedChannelData_When_TheFormatIsSrgba()
        {
            ...
            using (var imageFrame = BuildImageFrame(ImageFormat.Types.Format.Srgba, 3, 2, 16, bytes))
            {
                ...
                Assert.True(imageFrame.TryReadChannel(3, result));
                ...
                Assert.True(imageFrame.TryReadChannel(3, result, true));
        ...
        public void TryReadChannelFloat_ShouldReadTheSpecifiedChannelData_When_TheFormatIsVec32F1()
        {
            ...
            {
                Assert.True(imageFrame.TryReadChannel(0, result));
                Assert.AreEqual(new[] { 4.0f / 255, 5.0f / 255, 6.0f / 255, 1.0f / 255, 2.0f / 255, 3.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(0, result, false, true));
                Assert.AreEqual(new[] { 1.0f / 255, 2.0f / 255, 3.0f / 255, 4.0f / 255, 5.0f / 255, 6.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(0, result, true));
                Assert.AreEqual(new[] { 6.0f / 255, 5.0f / 255, 4.0f / 255, 3.0f / 255, 2.0f / 255, 1.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(0, result, true, true));
                Assert.AreEqual(new[] { 3.0f / 255, 2.0f / 255, 1.0f / 255, 6.0f / 255, 5.0f / 255, 4.0f / 255 },
                    result);
            }
        }
        ...
        public void TryReadChannelFloat_ShouldReadTheSpecifiedChannelData_When_TheFormatIsVec32F2()
        {
            ...
            {
                Assert.True(imageFrame.TryReadChannel(0, result));
                Assert.AreEqual(new[] { 9.0f / 255, 41.0f / 255, 73.0f / 255, 1.0f / 255, 33.0f / 255, 65.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(0, result, false, true));
                Assert.AreEqual(new[] { 1.0f / 255, 33.0f / 255, 65.0f / 255, 9.0f / 255, 41.0f / 255, 73.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(0, result, true));
                Assert.AreEqual(new[] { 73.0f / 255, 41.0f / 255, 9.0f / 255, 65.0f / 255, 33.0f / 255, 1.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(0, result, true, true));
                Assert.AreEqual(new[] { 65.0f / 255, 33.0f / 255, 1.0f / 255, 73.0f / 255, 41.0f / 255, 9.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(1, result));
                Assert.AreEqual(new[] { 10.0f / 255, 42.0f / 255, 74.0f / 255, 2.0f / 255, 34.0f / 255, 66.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(1, result, false, true));
                Assert.AreEqual(new[] { 2.0f / 255, 34.0f / 255, 66.0f / 255, 10.0f / 255, 42.0f / 255, 74.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(1, result, true));
                Assert.AreEqual(new[] { 74.0f / 255, 42.0f / 255, 10.0f / 255, 66.0f / 255, 34.0f / 255, 2.0f / 255 },
                    result);

                Assert.True(imageFrame.TryReadChannel(1, result, true, true));
                Assert.AreEqual(new[] { 66.0f / 255, 34.0f / 255, 2.0f / 255, 74.0f / 255, 42.0f / 255, 10.0f / 255 },
                    result);
            }
        }
        ...
        public void TryReadChannelNormalized_ShouldReadTheSpecifiedChannelData_When_TheFormatIsSrgba()
        {
            ...
            using (var imageFrame = BuildImageFrame(ImageFormat.Types.Format.Srgba, 3, 2, 16, bytes))
            {
                Assert.True(imageFrame.TryReadChannelNormalized(0, result));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(0, result, true));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(1, result));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(1, result, true));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(2, result));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(2, result, true));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(3, result));
                ...
                Assert.True(imageFrame.TryReadChannelNormalized(3, result, true));
        ...
        public void TryReadPixelData_ShouldReturnFalse_When_ColorsLengthIsWrong()
        {
            using (var imageFrame = BuildImageFrame(ImageFormat.Types.Format.Srgba, 0, 0, 0, new byte[] { }))
            {
                Assert.False(imageFrame.TryReadPixelData(new Color32[1] { new() }));
            }
        }
        ...
        public void TryReadPixelData_ShouldReturnTrue_When_TheFormatIsLab8()
        {
            ...
            var expected = new[]
            {
                new Color32(204, 161, 115, 255), new Color32(93, 169, 0, 255), new Color32(71, 68, 0, 255),
                new Color32(122, 0, 0, 255), new Color32(178, 0, 84, 255),
                new Color32(255, 255, 255, 255), new Color32(0, 255, 255, 255), new Color32(0, 255, 0, 255),
                new Color32(255, 139, 255, 255), new Color32(255, 70, 0, 255),
                new Color32(119, 119, 119, 255), new Color32(0, 169, 255, 255), new Color32(0, 152, 0, 255),
                new Color32(183, 0, 255, 255), new Color32(255, 0, 0, 255),
                new Color32(0, 0, 0, 255), new Color32(0, 64, 194, 255), new Color32(0, 45, 0, 255),
                new Color32(0, 0, 195, 255), new Color32(132, 0, 0, 255)
            };
