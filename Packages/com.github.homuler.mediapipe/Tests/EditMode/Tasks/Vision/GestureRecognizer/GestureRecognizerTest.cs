...
namespace Mediapipe.Tests.Tasks.Vision
{
    public class GestureRecognizerTest
    {
        ...
        private readonly Lazy<TextAsset> _gestureRecognizerModel =
            new(() => AssetDatabase.LoadAssetAtPath<TextAsset>($"{_ResourcePath}/gesture_recognizer.bytes"));

        private readonly Lazy<Texture2D> _thumbUpPicture =
            new(() => AssetDatabase.LoadAssetAtPath<Texture2D>($"{_TestResourcePath}/thumb-up.jpg"));
        ...
        {
            var options = new GestureRecognizerOptions(new BaseOptions());
        ...
        {
            var options =
                new GestureRecognizerOptions(new BaseOptions(modelAssetBuffer: _gestureRecognizerModel.Value.bytes));
        ...
        {
            var options = new GestureRecognizerOptions(new BaseOptions(BaseOptions.Delegate.CPU, "unknown_path.bytes"));
        ...
        public IEnumerator Create_returns_ObjectDetector_when_assetModelPath_is_valid()
        {
            ...
            var options =
                new GestureRecognizerOptions(new BaseOptions(BaseOptions.Delegate.CPU, "gesture_recognizer.bytes"));
        ...
        public void Recognize_ShouldReturnAnEmptyResult_When_ImageIsEmpty()
        {
            ...
            using (var gestureRecognizer = GestureRecognizer.CreateFromOptions(options))
            {
                ...
                {
                    var result = gestureRecognizer.Recognize(image);
        ...
        public void Recognize_ShouldReturnGestureRecognitionResult_When_HandGesturesAreDetected()
        {
            var options = new GestureRecognizerOptions(
                new BaseOptions(modelAssetBuffer: _gestureRecognizerModel.Value.bytes),
                RunningMode.IMAGE,
                2);
        ...
        public void RecognizeForVideo_ShouldReturnAnEmptyResult_When_ImageIsEmpty()
        {
            ...
            using (var gestureRecognizer = GestureRecognizer.CreateFromOptions(options))
            {
                ...
                using (var image = new Image(ImageFormat.Types.Format.Srgba, width, height, width * 4, pixelData))
                {
                    var result = gestureRecognizer.RecognizeForVideo(image, 1);
                    Assert.IsNull(result.gestures);
                }
            }
        }
