...
";
        ...
        [Test]
        public void
            ValidateRequiredSidePackets_ShouldNotThrow_When_TheConfigDoesNotRequireSidePackets_And_SidePacketIsEmpty()
        {
            using (var config = new ValidatedGraphConfig())
            {
                config.Initialize(CalculatorGraphConfig.Parser.ParseFromTextFormat(_PassThroughConfigText));
        ...
        [Test]
        public void
            ValidateRequiredSidePackets_ShouldNotThrow_When_TheConfigDoesNotRequireSidePackets_And_SidePacketIsNotEmpty()
        {
            using (var config = new ValidatedGraphConfig())
            {
                config.Initialize(CalculatorGraphConfig.Parser.ParseFromTextFormat(_PassThroughConfigText));
        ...
        [Test]
        public void
            ValidateRequiredSidePackets_ShouldThrowInvalidArgumentError_When_TheConfigRequiresSidePackets_And_SidePacketIsEmpty()
        {
            using (var config = new ValidatedGraphConfig())
            {
                ...
                {
                    var exception =
                        Assert.Throws<BadStatusException>(() => config.ValidateRequiredSidePackets(sidePacket));
        ...
        [Test]
        public void
            ValidateRequiredSidePackets_ShouldThrowInvalidArgumentError_When_AllTheRequiredSidePacketsAreNotGiven()
        {
            using (var config = new ValidatedGraphConfig())
            {
                config.Initialize(CalculatorGraphConfig.Parser.ParseFromTextFormat(_ImageTransformationConfigText));
        ...
        public void Config_ShouldReturnTheCanonicalizedConfig_When_TheConfigIsFaceDetectionShortRangeCommonConfig()
        {
            ...
            {
                var originalConfig =
                    CalculatorGraphConfig.Parser.ParseFromTextFormat(_FaceDetectionShortRangeConfigText);
                config.Initialize(originalConfig);
                var canonicalizedConfig = config.Config();
        ...
        public void InputSidePacketInfos_ShouldReturnEdgeInfoList_When_InputSidePacketsExist()
        {
            using (var config = new ValidatedGraphConfig())
            {
                ...
                var flowLimiterCalculatorOptionsPacket =
                    inputSidePacketInfos.First(edgeInfo => edgeInfo.name == "flow_limiter_calculator_options");
        ...
        public void RegisteredSidePacketTypeName_ShouldReturnInvalidArgumentError_When_TheSidePacketDoesNotExist()
        {
            using (var config = new ValidatedGraphConfig())
            {
                ...
                {
                    _ = config.RegisteredSidePacketTypeName("max_in_flight");
                });
                Assert.AreEqual(StatusCode.InvalidArgument, exception.statusCode);
            }
        }
