...
#pragma warning restore IDE0058
        ...
        public void ParseTagAndName_ShouldParseInput_When_InputIsValid(string input, string expectedTag,
            string expectedName)
        {
...
#pragma warning restore IDE0058
        ...
        public void ParseTagAndName_ShouldThrow_When_InputIncludesBadCharacters(
            [Values(' ', '-', '/', '.', ':')] char ch,
            [Values("MALE$0ACTOR:humphrey", "ACTOR:humphrey$0:bogart")]
            string str
        )
        {
        ...
        public void ParseTagIndexName_ShouldParseInput_When_InputIsValid(string input, string expectedTag,
            int expectedIndex, string expectedName)
        {
...
#pragma warning restore IDE0058
        ...
        public void ParseTagIndexName_ShouldThrow_When_InputIncludesBadCharacters(
            [Values('!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '{', '}', '[', ']',
                '/', '=', '?', '+', '\\', '|', '-', ';', ':', '\'', '"', '<', '.', '>')]
            char ch,
            [Values("$0", "$0a", "a$0", "$0:a", "A$0:a", "$0A:a", "A:$0:a", "A:$01:a", "A:1$0:a", "A:1:a$0", "$0A:1:a")]
            string str
        )
        {
        ...
        public void ParseTagIndex_ShouldParseInput_When_InputIsValid(string input, string expectedTag,
            int expectedIndex)
        {
...
#pragma warning restore IDE0058
        ...
        public void ParseTagIndex_ShouldThrow_When_InputIncludesBadCharacters(
            [Values('!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '{', '}', '[', ']',
                '/', '=', '?', '+', '\\', '|', '-', ';', ':', '\'', '"', '<', '.', '>')]
            char ch,
            [Values("$0", "$0A", "A$0", "$0:1", "A$0:1", "$0A:1", "A:1$0", "A:$01")]
            string str
        )
        {
