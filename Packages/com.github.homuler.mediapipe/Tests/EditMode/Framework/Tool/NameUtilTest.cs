...
namespace Mediapipe.Tests
{
    public class NameUtilTest
    {
        ...
        [TestCase(@"{""node"":[{""input_side_packet"":[""base""]},{""input_side_packet"":[""TAG:base_02""]}]}", "base",
            "base_03")]
        public void GetUnusedSidePacketName_ShouldReturnUniqueName(string configJson, string nameBase,
            string uniqueName)
        {
            var config = CalculatorGraphConfig.Parser.ParseJson(configJson);
        ...
        public void CanonicalNodeName_ShouldReturnCanonicalNodeName_When_NodeIdIsValid(string configJson, int nodeId,
            string name)
        {
            var config = CalculatorGraphConfig.Parser.ParseJson(configJson);
...
#pragma warning restore IDE0058
        ...
        public void ParseTagIndexFromStream_ShouldReturnTagIndexPair_When_InputIsValid(string stream, string tag,
            int index)
        {
