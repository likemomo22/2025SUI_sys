...
namespace Mediapipe.Tests.Util
{
    public class GlobalInstanceTableTest
    {
        ...
        [Test]
        public void Ctor_Throws_WhenMaxSizeIsLessThenZero()
        {
            Assert.Throws<ArgumentException>(() => new GlobalInstanceTable<int, Value>(-1));
        }
        ...
        [Test]
        [Ignore("Skip because it's non-deterministic")]
        ...
        public void TryGetValue_ReturnsFalse_IfTheKeyExists_But_TheValueIsGCed()
        {
            ...
            Assert.IsFalse(table.TryGetValue(1, out _));
        }
