...
namespace Mediapipe.Unity.Sample.Holistic.UI
{
    public class HolisticTrackingConfig : ModalContents
    {
        ...
        private const string _MinDetectionConfidencePath =
            "Scroll View/Viewport/Contents/Min Detection Confidence/InputField";

        private const string _MinTrackingConfidencePath =
            "Scroll View/Viewport/Contents/Min Tracking Confidence/InputField";
        ...
        private void InitializeModelComplexity()
        {
            ...
            if (defaultValue >= 0) _modelComplexityInput.value = defaultValue;
        ...
        {
            _refineFaceLandmarksInput =
                gameObject.transform.Find(_RefineFaceLandmarksPath).gameObject.GetComponent<Toggle>();
        ...
        {
            _enableSegmentationInput =
                gameObject.transform.Find(_EnableSegmentationPath).gameObject.GetComponent<Toggle>();
        ...
        {
            _smoothSegmentationInput =
                gameObject.transform.Find(_SmoothSegmentationPath).gameObject.GetComponent<Toggle>();
        ...
        {
            _minDetectionConfidenceInput = gameObject.transform.Find(_MinDetectionConfidencePath).gameObject
        ...
        {
            _minTrackingConfidenceInput = gameObject.transform.Find(_MinTrackingConfidencePath).gameObject
                .GetComponent<InputField>();
        ...
        private void InitializeRunningMode()
        {
            ...
            if (defaultValue >= 0) _runningModeInput.value = defaultValue;
        ...
        {
            _timeoutMillisecInput =
                gameObject.transform.Find(_TimeoutMillisecPath).gameObject.GetComponent<InputField>();
