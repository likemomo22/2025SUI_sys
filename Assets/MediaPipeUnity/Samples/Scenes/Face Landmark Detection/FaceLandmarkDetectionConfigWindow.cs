...
namespace Mediapipe.Unity.Sample.FaceLandmarkDetection.UI
{
    public class FaceLandmarkDetectionConfigWindow : ModalContents
    {
        ...
        {
            _config.Delegate = (BaseOptions.Delegate)_delegateInput.value;
            _isChanged = true;
        }
        ...
        {
            InitializeDropdown<BaseOptions.Delegate>(_delegateInput, _config.Delegate.ToString());
        ...
        private void InitializeOutputFacialTransformationMatrixes()
        {
            ...
            _outputFacialTransformationMatrixesInput.onValueChanged.AddListener(delegate
            {
                ToggleOutputFacialTransformationMatrixes();
            });
        }
    }
}