...
namespace Mediapipe.Unity.Sample.ImageSegmentation
{
    ...
    {
        [Description("HairSegmenter")] HairSegmenter = 0,
    ...
    public enum SelfieModelCategory
    {
        Person = 0
    }

    public enum HairModelCategory
    {
        Background = 0,
        Hair = 1
    }
    ...
    Tasks.Core.BaseOptions.Delegate.GPU;
        ...
        public ImageSegmenterOptions GetImageSegmenterOptions(
            ImageSegmenterOptions.ResultCallback resultCallback = null)
        {
