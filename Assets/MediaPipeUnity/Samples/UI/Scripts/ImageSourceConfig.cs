...
namespace Mediapipe.Unity.Sample.UI
{
    public class ImageSourceConfig : ModalContents
    {
        ...
        private void InitializeSourceType()
        {
            ...
            if (defaultValue >= 0) _sourceTypeInput.value = defaultValue;
        ...
        private void InitializeSource()
        {
            ...
            if (defaultValue >= 0) _sourceInput.value = defaultValue;
        ...
        private void InitializeResolution()
        {
            ...
            if (defaultValue >= 0) _resolutionInput.value = defaultValue;
