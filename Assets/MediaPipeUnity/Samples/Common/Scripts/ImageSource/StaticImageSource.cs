...
namespace Mediapipe.Unity
{
    ...
    {
        [SerializeField] private readonly Texture[] _availableSources;

        [SerializeField] private readonly ResolutionStruct[] _defaultAvailableResolutions =
        {
            new(512, 512, 0),
            new(640, 480, 0),
            new(1280, 720, 0)
        ...
        {
            if (image == null) throw new InvalidOperationException("Image is not selected");
        ...
        {
            if (!isPrepared) throw new InvalidOperationException("Image is not prepared");
            _isPlaying = true;
