...
namespace Mediapipe.Unity
{
    public class VideoSource : ImageSource
    {
        ...
        public override ResolutionStruct[] availableResolutions => video == null
            ? null
            : new[] { new ResolutionStruct((int)video.width, (int)video.height, video.frameRate) };
        ...
        public override void SelectSource(int sourceId)
        {
            ...
            if (_videoPlayer != null) _videoPlayer.clip = video;
        }

        public override IEnumerator Play()
        {
            if (video == null) throw new InvalidOperationException("Video is not selected");
        ...
        {
            if (!isPrepared) throw new InvalidOperationException("VideoPlayer is not prepared");
            if (!isPlaying) _videoPlayer.Play();
            yield return null;
        }
