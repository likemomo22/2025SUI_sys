...
namespace Mediapipe.Unity.Sample
{
    ...
    public class AppSettings : ScriptableObject
    {
        ...
        [Header("Glog settings")] [SerializeField]
        private int _glogMinloglevel = Glog.Minloglevel;
        ...
        [Header("Static Image Source")] [SerializeField]
        private Texture[] _availableStaticImageSources;
        ...
        public StaticImageSource BuildStaticImageSource()
        {
