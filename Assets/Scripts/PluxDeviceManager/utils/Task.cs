...
namespace UnityThreading
{
    ...
    {
        private readonly ManualResetEvent abortEvent = new(false);
        private readonly ManualResetEvent endedEvent = new(false);
        private readonly ManualResetEvent endingEvent = new(false);
        ...
        /// </summary>
        public bool ShouldAbort => abortEvent.InterWaitOne(0);

        /// <summary>
        ///     Returns true when processing of this task has been ended or has been skipped due early abortion.
        /// </summary>
        public bool HasEnded => hasEnded || endedEvent.InterWaitOne(0);

        /// <summary>
        ///     Returns true when processing of this task is ending.
        /// </summary>
        public bool IsEnding => endingEvent.InterWaitOne(0);
        ...
        /// </summary>
        public bool IsSucceeded => endingEvent.InterWaitOne(0) && !abortEvent.InterWaitOne(0);
        ...
        /// </summary>
        public bool IsFailed => endingEvent.InterWaitOne(0) && abortEvent.InterWaitOne(0);
    ...
    {
        private readonly Func<Task, T> function;
        private T result;
        ...
        {
            function = t => { return (T)enumerator; };
        }
        ...
        public Task(Type type, string methodName, params object[] args)
        {
            ...
            function = t => { return (T)methodInfo.Invoke(null, args); };
        }
        ...
        public Task(object that, string methodName, params object[] args)
        {
            ...
            function = t => { return (T)methodInfo.Invoke(that, args); };
        }
