...
namespace UnityThreading
{
    public abstract class DispatcherBase : IDisposable
    {
        ...
        protected ManualResetEvent dataEvent = new(false);
        protected Queue<Task> delayedTaskList = new();
        protected int lockCount;
        protected Queue<Task> taskList = new();
        protected object taskListSyncRoot = new();
    ...
    {
        public static NullDispatcher Null = new();
    ...
    {
        [ThreadStatic] private static Task currentTask;

        [ThreadStatic] internal static Dispatcher currentDispatcher;
        ...
        /// </summary>
        public static Dispatcher CurrentNoThrow => currentDispatcher;
        ...
        /// </summary>
        public static Dispatcher MainNoThrow => mainDispatcher;
