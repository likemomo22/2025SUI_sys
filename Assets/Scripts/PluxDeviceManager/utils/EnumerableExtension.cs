...
namespace UnityThreading
{
    public static class EnumerableExtension
    {
        ...
        /// <returns>IEnumerable of created tasks.</returns>
        public static IEnumerable<Task<TResult>> ParallelForEach<TResult, T>(this IEnumerable<T> that,
        ...
        /// <param name="action">The Func to perform for each element.</param>
        /// <returns>IEnumerable of created tasks.</returns>
        public static IEnumerable<Task<TResult>> SequentialForEach<TResult, T>(this IEnumerable<T> that,
            Func<T, TResult> action)
        {
